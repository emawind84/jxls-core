...
//    }
     ...
     */
    public void transformXLS(String srcFilePath, Map beanParams, String destFilePath) throws ParsePropertyException, IOException, InvalidFormatException, InterruptedException {
     ...
     * @throws InterruptedException 
     */
    public org.apache.poi.ss.usermodel.Workbook transformXLS(InputStream is, Map beanParams, TaskLink link) throws ParsePropertyException, InvalidFormatException, InterruptedException {
        org.apache.poi.ss.usermodel.Workbook hssfWorkbook = null;
        try {
            hssfWorkbook = WorkbookFactory.create(is);
            transformWorkbook(hssfWorkbook, beanParams, link);
        } catch (IOException e) {
            e.printStackTrace();
        }
        return hssfWorkbook;
    ...
    public org.apache.poi.ss.usermodel.Workbook transformXLS(InputStream is, Map beanParams) throws ParsePropertyException, InvalidFormatException {
    	try {
			return transformXLS(is, beanParams, null);
		} catch (InterruptedException e) {
			throw new RuntimeException(e);
		}
    }

    public void transformWorkbook(org.apache.poi.ss.usermodel.Workbook hssfWorkbook, Map beanParams) throws ParsePropertyException {
    	try {
			transformWorkbook(hssfWorkbook, beanParams, null);
		} catch (InterruptedException e) {
			throw new RuntimeException(e);
		}
    }

    public void transformWorkbook(org.apache.poi.ss.usermodel.Workbook hssfWorkbook, Map beanParams, TaskLink link) throws ParsePropertyException, InterruptedException {
        try {
            ...
            SheetTransformer sheetTransformer = new SheetTransformer( fixedSizeCollections, groupedCollections, rowProcessors, cellProcessors, configuration, link) ;
...
//            updateFormulas();
    ...
    public org.apache.poi.ss.usermodel.Workbook transformXLS(InputStream is, List
            ...
            throws ParsePropertyException, InvalidFormatException, InterruptedException {
        org.apache.poi.ss.usermodel.Workbook hssfWorkbook = null;
        try {
            hssfWorkbook = WorkbookFactory.create(is);
